  ...
  _createClass(OverlayViewCreator, [{
    ...
    value: function _createOverlayView(overlayViewProps) {
      ...
      overlayView.onRemove = function () {
        _reactDom2["default"].unmountComponentAtNode(this._containerElement);
      ...
      overlayView._renderContent = function () {
        _reactDom2["default"].render(_react.Children.only(this.get("children")), this._containerElement);
      };
